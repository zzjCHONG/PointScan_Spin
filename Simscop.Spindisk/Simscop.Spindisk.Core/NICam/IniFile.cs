...
namespace Simscop.Spindisk.Core.NICamera
{
    internal class IniFile
    {
        ...
        public uint GetUInt32(string sectionName,
                            string keyName,
                            uint defaultValue)
        {
            if (sectionName == null)
            ...
            return Convert.ToUInt32(retval, CultureInfo.InvariantCulture);
        }
                            ...
                            bool defaultValue)
        {
            ...
            return Convert.ToBoolean(retval, CultureInfo.InvariantCulture);
        }
        ...
        /// <summary>
        /// Writes an <see cref="T:System.Boolean"/> value to the ini file.
        /// </summary>
        /// <param name="sectionName">The name of the section to write to .</param>
        /// <param name="keyName">The name of the key to write to.</param>
        /// <param name="value">The value to write</param>
