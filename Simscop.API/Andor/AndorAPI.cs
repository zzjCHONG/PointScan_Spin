...
namespace Simscop.API
{
    public class AndorAPI
    {
        ...
        public static extern int IsImplemented(int Hndl, string Feature, ref bool Implemented);
        ...
        /// <param name="Hndl"></param>
        /// <param name="Feature"></param>
        /// <param name="isReadOnly">可实现返回AT_TRUE或，否则为AT_FALSE</param>
        /// <returns></returns>
        [DllImport("atcore.dll", EntryPoint = "AT_IsReadOnly", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        public static extern int IsReadOnly(int Hndl, string Feature, ref bool isReadOnly);
        ...
        /// <param name="Hndl"></param>
        /// <param name="Feature"></param>
        /// <param name="IsWritable">可实现返回AT_TRUE或，否则为AT_FALSE</param>
        /// <returns></returns>
        [DllImport("atcore.dll", EntryPoint = "AT_IsWritable", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        public static extern int IsWritable(int Hndl, string Feature, ref bool IsWritable);
        ...
        /// <param name="Hndl"></param>
        /// <param name="Feature"></param>
        /// <param name="IsReadable">可实现返回AT_TRUE或，否则为AT_FALSE</param>
        /// <returns></returns>
        [DllImport("atcore.dll", EntryPoint = "AT_IsReadable", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        public static extern int IsReadable(int Hndl, string Feature, ref bool IsReadable);
